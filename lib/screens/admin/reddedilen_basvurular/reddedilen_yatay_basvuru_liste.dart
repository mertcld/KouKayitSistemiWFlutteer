...
class ReddedilenYatayBasvuruListesi extends StatefulWidget {
  const ReddedilenYatayBasvuruListesi({Key? key}) : super(key: key);

  @override
  _ReddedilenYatayBasvuruListesiState createState() => _ReddedilenYatayBasvuruListesiState();
}

class _ReddedilenYatayBasvuruListesiState extends State<ReddedilenYatayBasvuruListesi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "Reddedilen Yatay Geçiş Başvuruları",
      ...
      body: Material(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: _yatayBasvuruService.reddedilenBasvurulariGetirAdmin(),
