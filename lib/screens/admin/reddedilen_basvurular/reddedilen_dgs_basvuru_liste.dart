...
class ReddedilenDgsListesi extends StatefulWidget {
  const ReddedilenDgsListesi({Key? key}) : super(key: key);

  @override
  _ReddedilenDgsListesiState createState() => _ReddedilenDgsListesiState();
}

class _ReddedilenDgsListesiState extends State<ReddedilenDgsListesi> {
    ...
    return Scaffold(
      ...
      body: Material(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: _dgsBasvuruService.reddedilenBasvurulariGetirAdmin(),
