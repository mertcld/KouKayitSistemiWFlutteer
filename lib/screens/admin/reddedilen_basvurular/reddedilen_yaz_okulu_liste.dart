...
class ReddedilenYazOkuluListe extends StatefulWidget {
  const ReddedilenYazOkuluListe({Key? key}) : super(key: key);

  @override
  _ReddedilenYazOkuluListeState createState() => _ReddedilenYazOkuluListeState();
}

class _ReddedilenYazOkuluListeState extends State<ReddedilenYazOkuluListe> {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        title: Text(
          "Reddedilen Yaz Okulu Başvuruları",
      ...
      body: Material(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: _yazOkuluBasvuruService.reddedilenBasvurulariGetirAdmin(),
